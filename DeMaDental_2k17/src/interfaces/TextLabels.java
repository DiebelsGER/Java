...
public interface TextLabels {
	...
	public String[] colheadsAuftrag = {"Auftrag-ID", "Auftrag-Nr.", "Auftrag-Datum", "Kunden-Name", "Patienten-Name", "Arbeitsart", "Auftrag-Typ", "Versicherung", "Abgeschlossen"};
	public String[] colheadsBenutzer = {"Benutzer-Nr.", "Vorname", "Name", "Berechtigung"};
	public String[] colheadsPatientAuftrag = {"Auftrag-Datum", "Auftrag-Nr.", "Auftrag-Typ", "Kunde", "Kieferbereich", "Arbeitsart", "Zahnfarbe" , "Legierung", "Abgeschlossen"};
	public String[] colheadsPatienten = {"ID", "Patienten-Name", "Versicherung", "IMPEX plus-Nr."};
